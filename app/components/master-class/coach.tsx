    ...
    >
      ...
      <div className="flex flex-col gap-5">
        ...
        <p className="text-lg mb-8 text-gray-300">
          ...
          Digital Affiliate Marketer that has been able to win car, traveled to
          different countries on vacation and In just 24 months, she has
        ...
        <p className="text-lg mb-8 text-gray-300">
          ...
          <span className="text-pink-400">proud millionaire</span>
          who helps other serious minded people change their financial life.
        </p>

        <div className="grid gap-5 grid-cols-3 md:grid-cols-3">
